    ...
    return (
      <div className="flex items-center justify-between gap-3 px-4 py-2 bg-slate-50 dark:bg-[#04070F]/70 backdrop-blur-md border border-slate-200 dark:border-rose-500/20 rounded-full select-none">
        ...
        <button
          ...
          className="text-xs font-bold text-rose-600 dark:text-rose-300 hover:text-rose-800 dark:hover:text-white flex items-center gap-1.5 transition-colors px-3 py-1 rounded-full hover:bg-rose-50 dark:hover:bg-rose-500/15 border border-transparent hover:border-rose-200 dark:hover:border-rose-500/30"
